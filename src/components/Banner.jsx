...
const Banner = () => {
    return (
        <div className='grid lg:grid-cols-7 container mx-auto mt-10 mb-16 gap-10 w-11/12 bg-blue-50 p-6 md:p -0 md:pl-10 rounded-xl'>
            ...
            <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white ml-24 lg:ml-0 rounded-lg text-lg text-white py-2 px-4 font-medium mt-10">Get Started</button>
            </div>
